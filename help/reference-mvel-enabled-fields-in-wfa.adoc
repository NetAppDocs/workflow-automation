...
* *_Workflow_* > *Details* > *Constants* > *Value*
...
* *Commands* > *_parameter_name_* > *Attributes*
...
* *_Workflow_* > *Workflow* > *Repeat row* > *Repeats* > *Number of times*
* *_Workflow_* > *Workflow* > *Repeat row* > *Variables* > *Variables for initial_value and expression*
* *Workflow* > *Workflow* > *Repeat row* > *Repeats* > *For every resource in a group* > *Resource Search Criteria* > *Parameters to filter*
* *_Workflow_* > *Workflow* > *Add condition* > *If the following expression is TRUE*
